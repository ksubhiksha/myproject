...
{
	e.printStackTrace();
	System.out.println("Exception while getting information in tslist.jsp :: " +e.getMessage());
}
...
<form id="frmTsList" name="frmTsList" method="POST" autocomplete="off">
    <div id="wrapper">
	...
	<div id="page-wrapper" class="gray-bg">
    	...
    	<div class="wrapper wrapper-content animated fadeInRight">
     	...
     	<input type='hidden' name='ts_main_id' id='ts_main_id' value="0"/>
...
function funEditProject(ts_main_id)
{
	$("#pageaction").val("TS_LIST_TO_ENTRY");
	$("#ts_main_id").val(ts_main_id);
	$("#screenload").show();
	$.ajax(
	{
		type	: 	"post",
		url		: 	"setsessionvariables.jsp",
		data	: 	$("form#frmTsList").serialize(),
		beforeSend: function() {
		},
		complete: function() {					
		},
		...
		{
			$("#frmTsList").attr("action", "tsentry.jsp");
			$("#frmTsList").submit();
		}
	});
}
